...
2026-08-28 14:10:27.13519

<!-- NEWS.md is generated from NEWS.Rmd. Please edit that file -->

    #> Last Update: 2026-08-28 14:10:27.206131

# BCGcalc 2.3.1.9007 (2026-08-28)

- refactor: Update GP (MO) Bug Rules, Issue \#103
  - Rules.xlsx

# BCGcalc 2.3.1.9006 (2026-08-14)

- refactor: Update GP Bug Rules, Issue \#102
  - Rules.xlsx
...
- refactor: Bump version number for resubmittal to CRAN, Issue \#100

# BCGcalc 2.3.0.9004 (2026-07-31)

- refactor: Move Shiny example files to BCGcalc_ORWA, Issue \#100
...
- docs: Increase version for CRAN release

# BCGcalc 2.2.0.9013 (2026-07-23)

- refactor: Updates for CRAN, Issue \#100
- docs: Add cran comments to \_test
...
- refactor: Update documentation for metrics_values, Issue \#100
- refactor: Make examples run times shorter, Issue \#100
...
- fix: Change Shiny import routine for BCG_Attr and BCG_Attr2
  - Certain conditions the imported file had all values on each row
- fix: Update MetricFlags.xlsx
  - ORWA flags from 2.1.0.9035 file symbols to be R compliant
- docs: Update NEWS file for undocumented updates.
- tests: Add nt_largeriver as a non BioMonTools metric for testing for
  MetricFlags.xlsx

# BCGcalc 2.1.0.9040 (2026-07-02)

- docs: Originally added as 2.1.0.9035
...
# BCGcalc 2.1.0.9039 (2026-06-25)

- Updated rules to fix Kansas rules

# BCGcalc 2.1.0.9038 (2026-06-24)

- Updated rules to replace pi_COEPT_BCG_att234b4m with
  pi_COEPT_BCG_att1i234b4m.

# BCGcalc 2.1.0.9037 (2026-06-24)

- Added rules for Oklahoma associated with GP BCG

# BCGcalc 2.1.0.9036 (2026-06-24)

- Updated OWRA and Kansas bug BCG rules

# BCGcalc 2.1.0.9035 (2026-06-23)

- Updated OWRA rules and metric flags per Jen’s updates on 06/23
...
- refactor: Update Rules.xlsx for BCG_ORWA_v1_Bugs500ct
...
- refactor: Update Rules.xlsx with Metric_Sort column
  - LBR Bugs and Fish
...
- refactor: Add rules, Boise BCG, Bugs
- refactor: Add flags, Boise BCG, Bugs
- refactor: Update Vignette due to m2 fields from new metrics
  - BCGcalc_Map.Rmd
  - vignette_BCGcalc.Rmd

# BCGcalc 2.1.0.9027 (2025-12-26)
...
- docs: Update LICENSE files and reference in DESCRIPTION
- docs: Move BioMonTools from Imports to Suggests in DESCRIPTION
