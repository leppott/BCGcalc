...
ogr_shp <- sf::st_read(dsn = fn_shp, layer = "MaritimeBCGclass_20230920_dissolved")
fort_shp <- ggplot2::fortify(ogr_shp)
# 111 MB

# 2. Save as RDA for use in package----
data_GIS_BCGclass <- fort_shp
usethis::use_data(data_GIS_BCGclass, overwrite = TRUE)
# 57.7 MB, dissolved is 34.4 MB
