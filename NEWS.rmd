...
* refactor: Add error for level.membership for missing metrics in data, Issue #54
...
* refactor: Make smaller versions (1000 records) of example files, Issue #100
    + Data_BCG_PugLowWilVal.xlsx
    + ExampleMunge_UnformattedData.xlsx

# BCGcalc 2.3.0.9002 (2026-07-30)

* docs: Update package description with more detail and references per CRAN fix,
Issue #100
...
* refactor: Update Rules.xlsx
    + Remove metric nt_ti_stenocold_cold_cool from  BCG_ORWA_v1_Bugs500ct, Foothills_Multihab 
...
* refactor: Update rules and flags for ORWA
    + 6 to 6m6t
* refactor: Modify deprecated input col_SITE_TYPE message with global binding
...
* tests: Add nt_largeriver as a non BioMonTools metric for testing for MetricFlags.xlsx

# BCGcalc 2.1.0.9040 (2026-07-02)

* docs: Originally added as 2.1.0.9035
* refactor: Comment out user file columns for statewide model in Shiny app
* refactor: Add check for existing column for Exclude taxa in statewide model
...
* Updated rules to replace pi_COEPT_BCG_att234b4m with pi_COEPT_BCG_att1i234b4m.
...
* refactor: Add ORWA Statewide BCG classes (20260603) to Shiny data folder
   + In preparation for addition of ORWA index assign class to
     Shiny app calculator
...
* refactor: Update Generate BCG Class parameters to include watershed area
...
* fix: Update calls to StreamCatTools for Shiny getClassParam function, Issue #93
