...
Installation
-----------------
To install the current version use the code below to install from GitHub. The use of “force = TRUE” ensures the package is installed even if already present. If the package devtools is missing the code below will install it.
...
All dependent libraries should install with the install_github command but occassionally they do not.  If you encounter issues the dependant libraries can be installed separately with the command below.
