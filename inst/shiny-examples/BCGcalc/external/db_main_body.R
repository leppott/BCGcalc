...
function(id) {
    ...
    tabItems(
      ...
      , tabItem(tabName = "tab_filebuilder_taxatrans", tab_code_filebuilder_taxatrans())
      , tabItem(tabName = "tab_filebuilder_indexclass", tab_code_filebuilder_indexclass())
      , tabItem(tabName = "tab_calc_bcg", tab_code_calc_bcg())
      , tabItem(tabName = "tab_calc_thermalmetrics", tab_code_calc_thermalmetrics())
      , tabItem(tabName = "tab_calc_thermalfuzzy", tab_code_calc_thermalfuzzy())
