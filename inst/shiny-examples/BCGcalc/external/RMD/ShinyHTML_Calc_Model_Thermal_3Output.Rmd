...
The BCG style thermal model uses the same style files as the BCG calculation.
...
df_data <- read_excel(path_data, sheet = "Calc_ModTherm")

# Display
cap_data <- "Calculation, Thermal Model, zip file contents."
