...
Region (PNMR) of Oregon and Washington (Figure 2). It also calculates thermal preference metrics and probability of membership in cold, cool or warm-water communities, which can help inform restoration and protection efforts and 
...
```{r, echo=FALSE, out.width="50%", fig.cap="Figure 2. The Pacific Northwest Maritime Region (PNMR) of Oregon and Washington includes five Omernik Level 3 ecoregions: Coast Range, Puget Lowland, Willamette Valley, Cascades, and North Cascades, excluding xeric regions (< 650 mm mean annual precipitation)."}
