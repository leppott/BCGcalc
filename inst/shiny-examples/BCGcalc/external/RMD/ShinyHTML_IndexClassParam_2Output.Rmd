...
look like those in Table 1 below.

The results file will retain all columns from the input file.  Additional fields
will be added from the StreamCat and NHDplus datasets as described in the Table 
2 below.
